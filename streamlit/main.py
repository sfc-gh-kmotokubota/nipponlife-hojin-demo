...
apps = [
    ...
    ("🎙", "面談録音・要約", "音声ファイルをアップロードするだけで文字起こし・要約・コンプライアンスチェック・Salesforce登録まで自動化。"),
    ("📊", "見込み管理", "担当20社の見込みをPipedriveスタイルで管理。C→B昇格チェックリストで進捗を見える化。"),
    ("🔍", "商品マッチング", "4軸の説明可能AIで最適商品を根拠付きでスコアリング。Databricksの「精度が怪しい」マッチングを上回る。"),
    ("📄", "提案書自動生成", "企業名と商品を選んでボタン1つ。最新情報が差し込まれたPPTX・Word提案書が30秒で完成。"),
